...
#import "MChoiceViewController.h"
#import "GuageExam.h"
#import "ReadJson.h"
...
@interface MChoiceViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation MChoiceViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    cell.optionLabel.text = model.selections[indexPath.row];
        ...
        cell.imgView.image = [UIImage imageNamed:@"mchoice_unchecked"];
        if ([model.answers containsObject:model.selections[indexPath.row]]) {
            cell.imgView.image = [UIImage imageNamed:@"mchoice_checked"];
        }
...
//多选
    ...
    if ([model.answers containsObject:model.selections[indexPath.row]]) {
        [model.answers removeObject:model.selections[indexPath.row]];
    }else{
